...
if (str_contains($product_meta, 'Free Product')) {
  $productClasses[] = 'is_free_product';
}
?>
...
<div data-key="<?php echo $cart_item_key ?>" class="<?php echo implode( ' ', $productClasses ) ?>">
	...
	<div class="xoo-wsc-sum-col">
        ...
        if( $showPmeta ) {
          if (str_contains($product_meta, 'Free Product')) {
            $product_meta = str_replace('Type:', 'Included', $product_meta);
            $product_meta = str_replace('Free Product', '', $product_meta);
