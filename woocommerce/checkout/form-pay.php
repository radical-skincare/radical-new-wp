	...
	<table class="shop_table">
		...
		<tbody>
			<?php if ( count( $order->get_items() ) > 0 ) : ?>
              ...
              <?php
              $image = wp_get_attachment_image_src( get_post_thumbnail_id( $item->get_ID() ), 'single-post-thumbnail' );
              if ($image) {
              ?>
                <img src="<?php  echo $image[0]; ?>" width="120" alt="<?php echo $item->get_name();?>">
							<?php
              }
