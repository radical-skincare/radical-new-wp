...
foreach ( $items as $item_id => $item ) :
    ...
    <td class="td" style="text-align:<?php echo esc_attr( $text_align ); ?>; vertical-align:middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
      ...
      if ( $item->get_subtotal() !== $item->get_total() ) {
				...
				echo '<div style="color: '.get_option( "woocommerce_email_base_color" ).';display: block;">' . sprintf( esc_html__( '%s discount', 'woocommerce' ), wc_price( wc_format_decimal( $item->get_subtotal() - $item->get_total(), '' ), array( 'currency' => $order->get_currency() ) ) ) . '</div>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
      ?>
		</td>
	</tr>
